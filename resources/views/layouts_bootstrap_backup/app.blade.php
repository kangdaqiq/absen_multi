    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            @if(auth()->user()->role === 'super_admin')
                ...
                <li class="nav-item {{ request()->routeIs('super-admin.licenses.*') ? 'active' : '' }}">
            ...
            @endif
                ...
                <!-- Kartu Gerbang -->
                <li class="nav-item {{ request()->routeIs('gate-cards.*') ? 'active' : '' }}">
                    <a class="nav-link" href="{{ route('gate-cards.index') }}">
                        <i class="fas fa-id-badge"></i>
                        <span>Kartu Gerbang</span>
                    </a>
                </li>
                    ...
                    <div id="collapseAbsensi" class="collapse {{ $isAbsensiActive ? 'show' : '' }}"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item {{ request()->routeIs('absensi-guru.*') ? 'active' : '' }}"
                                href="{{ route('absensi-guru.index') }}">Absensi {{ $labelKaryawan }}</a>
                            ...
                            <a class="collapse-item {{ request()->routeIs('rekap-guru.*') ? 'active' : '' }}"
                                href="{{ route('rekap-guru.index') }}">Rekap {{ $labelKaryawan }}</a>
                        </div>
                    </div>
                </li>
            @endif
            ...
            @if(auth()->user()->role === 'admin' && !$isOffice)
                @php
