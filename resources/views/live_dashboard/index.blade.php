...
<div class="flex flex-col gap-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div class="bg-white dark:bg-boxdark rounded-lg shadow-sm border border-stroke dark:border-strokedark px-6 py-3 flex items-center gap-4">
            <div class="text-right">
                <p id="live-date" class="text-xs text-gray-500 dark:text-gray-400 font-medium uppercase tracking-wider"></p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        {{-- Total Siswa --}}
        <div class="bg-white dark:bg-boxdark rounded-xl shadow-sm border-l-4 border-blue-500 p-6 flex items-center justify-between transition-all hover:shadow-md">
            <div>
        ...
        {{-- Siswa Absen (A+S+I+B) --}}
        <div class="bg-white dark:bg-boxdark rounded-xl shadow-sm border-l-4 border-red-500 p-6 flex items-center justify-between transition-all hover:shadow-md">
            <div>
                <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Siswa Absen (A/S/I/B)</p>
        ...
        {{-- Siswa Belum Absen --}}
        <div class="bg-white dark:bg-boxdark rounded-xl shadow-sm border-l-4 border-orange-500 p-6 flex items-center justify-between transition-all hover:shadow-md">
            <div>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        {{-- Hadir --}}
        <div class="bg-white dark:bg-boxdark rounded-lg p-4 border border-stroke dark:border-strokedark flex items-center gap-4">
            <div class="h-10 w-10 rounded bg-green-50 dark:bg-green-900/20 flex items-center justify-center flex-shrink-0">
        ...
        {{-- Izin --}}
        <div class="bg-white dark:bg-boxdark rounded-lg p-4 border border-stroke dark:border-strokedark flex items-center gap-4">
            <div class="h-10 w-10 rounded bg-blue-50 dark:bg-blue-900/20 flex items-center justify-center flex-shrink-0">
        ...
        {{-- Sakit --}}
        <div class="bg-white dark:bg-boxdark rounded-lg p-4 border border-stroke dark:border-strokedark flex items-center gap-4">
            <div class="h-10 w-10 rounded bg-yellow-50 dark:bg-yellow-900/20 flex items-center justify-center flex-shrink-0">
    ...
    <div class="bg-white dark:bg-boxdark rounded-xl shadow-sm border border-stroke dark:border-strokedark overflow-hidden">
        <div class="bg-gray-50 dark:bg-meta-4 px-6 py-4 border-b border-stroke dark:border-strokedark flex items-center justify-between">
            <h3 class="font-bold text-gray-800 dark:text-white flex items-center gap-2">
                <i class="fas fa-list-ul text-brand-500"></i>
                Aktivitas Terbaru
            </h3>
            <span class="text-xs text-gray-500 dark:text-gray-400 italic">Terakhir diperbarui: <span id="last-update">--</span></span>
        </div>
            ...
            <table class="w-full">
                <thead>
                    <tr class="text-left bg-gray-100 dark:bg-meta-4/50">
                        ...
                        <th class="px-6 py-3 text-xs font-bold text-gray-500 dark:text-gray-400 uppercase">Keterangan</th>
                        <th class="px-6 py-3 text-xs font-bold text-gray-500 dark:text-gray-400 uppercase text-center">Status</th>
                    </tr>
                </thead>
                <tbody id="log-body">
