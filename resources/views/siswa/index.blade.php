                        ...
                        <td class="border-b border-gray-100 px-4 py-4 dark:border-gray-800">
                            <div class="flex items-center justify-center gap-2" x-data="{}">
                                ...
                                <button class="btnEnrollFinger text-green-500 hover:text-green-700 hover:bg-green-50 p-2 rounded-lg transition" 
                                    data-id="{{ $s->id }}" data-nama="{{ $s->nama }}" data-finger="{{ $s->id_finger }}" data-school="{{ $s->school_id }}"
                                ...
                                <template x-for="(item, i) in failures" :key="i">
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/40 transition">
                                        ...
                                        <td class="px-3 py-2 align-top">
                                            ...
                                            <div class="text-[11px] text-gray-500 dark:text-gray-400 font-mono" x-text="item.nis ? 'NIS: ' + item.nis : ''"></div>
                                        </td>
        ...
        function importFormSiswa() {
            return {
                ...
                copyErrors() {
                    ...
                    const text = "Rincian Gagal Import Data Siswa:\n" + 
                        this.failures.map(f => `- Baris ${f.row}: ${f.nama} (NIS: ${f.nis || '-'}) => ${f.reason}`).join('\n');
