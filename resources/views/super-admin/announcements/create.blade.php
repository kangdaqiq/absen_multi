            ...
            <div class="p-6.5">
                <form action="{{ route('super-admin.announcements.store') }}" method="POST">
                    ...
                    <div class="mb-4.5">
                        ...
                        <input type="text" name="title" value="{{ old('title') }}" required autofocus class="w-full rounded border border-stroke bg-transparent py-3 px-5 outline-none transition focus:border-brand-500 active:border-brand-500 dark:border-form-strokedark dark:bg-form-input dark:focus:border-brand-500 @error('title') border-danger @enderror" />
                        @error('title')
