                    ...
                    <form action="{{ route('super-admin.schools.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="code"
                                value="[Dibuat Otomatis]" readonly disabled>
                            <small class="form-text text-muted">Kode unik akan di-generate secara otomatis oleh sistem.</small>
                        </div>
